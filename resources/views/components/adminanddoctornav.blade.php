<nav class="dashboard-nav">
    ...
    <ul>
        ...
        <li><a href="{{route('patientlist.showpatient')}}" @if(Request::is('admin/*patient*')) class="current" @endif>รายชื่อผู้เข้ารับการรักษา</a></li>
        <li><a href="{{route('doctor.showdoctor')}}" @if(Request::is('admin/*doctor*')) class="current" @endif>รายชื่อแพทย์</a></li>
    ...
    <ul>
        ...
        <li><a href="{{route('Doctor.shpwpatient')}}"@if(Request::is('admin/*patient*')) class="current" @endif>รายชื่อผู้เข้ารับรักษาของคุณ</a></li>
